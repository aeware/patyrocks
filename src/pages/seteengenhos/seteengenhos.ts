...
/**
 * Generated class for the seteengenhosPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-seteengenhos',
  templateUrl: 'seteengenhos.html',
})
export class SeteengenhosPage {
  ...
  atualizaCalculos(){
    ...
    this.authServices.postData({}, "products_by_brand/seteengenhos").then((result) => {
      localStorage.set
