...
/**
 * Generated class for the GelotimoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-gelotimo',
  templateUrl: 'gelotimo.html',
})
export class GelotimoPage {
  ...
  atualizaCalculos(){
    ...
    this.authServices.postData({}, "products_by_brand/gelotimo").then((result) => {
      localStorage.set
