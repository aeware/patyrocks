...
@IonicPage()
@Component({
  selector: 'page-calculateproducts',
  templateUrl: 'calculateproducts.html',
})
export class CalculateProductsPage {
  ...
  atualizaCalculos(){
    ...
    this.authServices.postData({}, "products_products").then((result) => {
      localStorage.set
